    ...
    return (
        <div className='container'>
            <main>
                <div className='hero'>
                    <div>
                        <h2 className='fade-1'>Thanks for considering my application for <br class='br'></br><span className='readme'>The Athletic</span>.</h2>
                        <p className='fade-2'>
                            As a community advocate and global-minded empath, I respect and admire the good work being done at <span className='readme'>The Athletic</span>.
                        </p>
                        <p className='fade-2'>
                        ...
                        <p className="has-text-align-left code fade-3">
                            <code>
                                <a href="https://jobs.lever.co/theathletic/154a8623-7b4f-42b0-82e6-2e5ee030a2a0" data-type="URL" target="_blank" rel="noreferrer noopener">
